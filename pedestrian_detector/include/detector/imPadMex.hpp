...
/*
 * This file contains the Piotr Dollar's imPadMex.cpp file.
 *
 * Please copy the contents of the file imPadMex.cpp to this file, after
 * the line: 
 *     #define IMPADMEX_HPP_, 
 */
#ifndef IMPADMEX_HPP_
#define IMPADMEX_HPP_
