...
/*
 * This file contains the Piotr Dollar's imResampleMex.cpp file.
 *
 * Please copy the contents of the file imResampleMex.cpp to this file, after
 * the line: 
...
void resample( T *A, T *B, int ha, int hb, int wa, int wb, int d, T r ) {
  ...
  for( z=0; z<d; z++ ) for( x=0; x<wb; x++ ) {
    ...
    float *Af0, *Af1, *Af2, *Af3, *Bf0, *Cf, wtf, wt1f;
